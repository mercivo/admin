...
function App() {
  ...
  const querySite = new URLSearchParams(location.search).get('site');
  ...
  const pathProductId = location.pathname.match(/^\/products\/([^/]+)$/)?.[1];
